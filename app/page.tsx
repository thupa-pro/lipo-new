...
export const metadata = {
  title:
    'Loconomy - AI-Powered Local Services Platform | Find Trusted Professionals Instantly',
  description:
    'Connect with verified local service professionals through our intelligent platform. From emergency repairs to wellness coaching - find trusted providers with AI-powered matching, real-time availability, and smart recommendations. 98.7% success rate.',
  keywords: [
    'local services',
    'AI marketplace',
    'service providers',
  ...
  openGraph: {
    ...
    description:
      'Connect with verified local service professionals through our intelligent platform. 98.7% success rate, instant matching, live support 24/7.',
    images: [
      {
        url: '/og-image.png',
        width: 1200,
  ...
  twitter: {
    ...
    title: 'Loconomy - AI-Powered Local Services Platform',
    description:
      'Connect with verified local service professionals through our intelligent platform. 98.7% success rate.',
...
const defaultCategories = [
  {
    ...
    slug: 'home-services',
    description:
      'Plumbing, electrical, cleaning, and repairs. Professional home maintenance.',
    icon_name: 'home',
  },
  {
    id: '2',
    ...
    description:
      'Personal trainers, yoga, nutrition coaching, and wellness services.',
    icon_name: 'dumbbell',
  },
  {
    id: '3',
    ...
    description:
      'Expert tutors for all subjects, test prep, and skill development.',
  ...
  },
  {
    ...
    slug: 'automotive',
    description:
      'Car repair, maintenance, detailing, and automotive expertise.',
    icon_name: 'car',
  },
  {
    id: '6',
    ...
    slug: 'entertainment',
    description:
      'Event planning, photography, music, and entertainment services.',
  ...
  },
  {
    ...
    description:
      'Consulting, accounting, legal, and professional business support.',
    icon_name: 'briefcase',
  },
  {
    id: '8',
    ...
    description:
      'Design, writing, marketing, and creative professional services.',
    icon_name: 'palette',
  },
]
...
const structuredData = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description:
        'AI-Powered Local Services Platform connecting customers with verified service professionals',
      foundingDate: '2023',
      contactPoint: {
        '@type': 'ContactPoint',
      ...
      <HomeClientComponents>
        <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-black transition-colors duration-500">
          ...
          <main id="main-content" className="relative z-10" role="main">
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <Badge className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-md border border-gray-200/50 dark:border-gray-700/50 text-gray-900 dark:text-white px-6 py-3 text-sm font-medium rounded-full shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-semibold">
                        ...
                        {stats.liveProviders.toLocaleString()}+ Active
                        Professionals
                      </span>
                      <Badge
                        variant="secondary"
                        className="ml-2 text-xs bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400"
                      >
                        24/7
                      </Badge>
                    </div>
                ...
                <div className="text-center mb-12 lg:mb-16">
                  ...
                  >
                    ...
                    <span className="text-gray-900 dark:text-white">
                      <span className="hidden sm:inline">with </span>AI-Powered
                      Matching
                    </span>
                  </h1>
                  ...
                  <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed font-medium">
                    ...
                    in seconds. From emergency repairs to wellness coaching -
                    our AI finds your perfect match.
                  </p>
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-6 mt-8">
                    <div className="flex items-center gap-2">
                      <div className="flex -space-x-2">
                        {[...Array(5)].map((_, i) => (
                          <div
                            key={i}
                            className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 border-2 border-white dark:border-gray-900 flex items-center justify-center text-white text-xs font-bold"
                          >
                      ...
                      <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                        Trusted by {(stats.userCount / 1000000).toFixed(1)}M+
                        users
                      </span>
                    </div>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="ml-1 text-sm font-medium text-gray-700 dark:text-gray-300">
                        {stats.averageRating}/5 ({stats.satisfactionRate}{' '}
                        satisfaction)
                      </span>
                    </div>
                  </div>
                            ...
                            <div className="flex items-center bg-gray-50 dark:bg-gray-800/50 backdrop-blur rounded-2xl p-5 border border-gray-200/50 dark:border-gray-700/50 transition-all duration-300 group-hover:border-blue-300 dark:group-hover:border-blue-600 focus-within:border-blue-500 focus-within:ring-4 focus-within:ring-blue-500/10">
                              ...
                              <div className="flex-1">
                                ...
                                <div id="service-help" className="sr-only">
                                  Enter the type of service you're looking for,
                                  such as plumbing, tutoring, or house cleaning
                                </div>
                              </div>
                              <Badge
                                variant="secondary"
                            ...
                            <div className="flex items-center bg-gray-50 dark:bg-gray-800/50 backdrop-blur rounded-2xl p-5 border border-gray-200/50 dark:border-gray-700/50 transition-all duration-300 group-hover:border-purple-300 dark:group-hover:border-purple-600 focus-within:border-purple-500 focus-within:ring-4 focus-within:ring-purple-500/10">
                              ...
                              <div className="flex-1">
                                ...
                                <div id="location-help" className="sr-only">
                                  Enter your city, zip code, or allow location
                                  access
                                </div>
                              </div>
                              <Button
                        ...
                        <div className="flex items-center gap-6">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-blue-100 text-lg">
                              Get matched with pros in minutes
                            </p>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                  {[
                    ...
                    <Card
                      key={index}
                      className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border border-gray-200/50 dark:border-gray-700/50 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 rounded-2xl"
                    >
                      <CardContent className="p-6 text-center">
                        <div
                          className={`p-4 bg-gradient-to-r ${stat.gradient} rounded-2xl w-fit mx-auto mb-4`}
                        >
            ...
            <section
              className="py-16 sm:py-20 md:py-24 bg-white/50 dark:bg-gray-800/20"
              role="region"
            ...
            >
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                  <Badge
                    variant="secondary"
                    className="mb-6 px-4 py-2 text-sm font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800"
                  >
                  ...
                  <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed">
                    Experience the future of local services with our AI-powered
                    platform that connects you with verified professionals in
                    your community.
                  </p>
                </div>
                  ...
                  {[
                    {
                      ...
                      description:
                        'Every professional is thoroughly background-checked, licensed, and insured. Your safety and satisfaction are guaranteed.',
                    ...
                    },
                    {
                      ...
                      description:
                        'Our intelligent algorithm learns your preferences and matches you with the perfect professionals for your specific needs.',
                      gradient: 'from-purple-500 to-pink-500',
                      features: [
                    ...
                    },
                    {
                      ...
                      description:
                        'Connect with available professionals in real-time. Get quotes, schedule services, and track progress seamlessly.',
                      gradient: 'from-green-500 to-teal-500',
                      features: [
                        'Real-time matching',
                        'Instant quotes',
                    ...
                    >
                      <EnhancedCardContent className="p-8">
                        <div className="mb-6">
                          <div
                            className={`w-20 h-20 mx-auto rounded-3xl bg-gradient-to-r ${feature.gradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                          >
            ...
            <Suspense
              fallback={
                <div className="h-96 animate-pulse bg-gray-200 dark:bg-gray-700 rounded-3xl mx-4"></div>
              }
            >
              <HomePageClient />
            </Suspense>
            ...
            >
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                  <Badge
                    variant="secondary"
                    className="mb-6 px-4 py-2 text-sm font-medium bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 border border-purple-200 dark:border-purple-800"
                  >
                  ...
                  <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                    Explore thousands of verified service providers across all
                    major categories.
                  </p>
                </div>
                  ...
                  {categories.map((category, index) => {
                    ...
                    return (
                      ...
                      >
                        <EnhancedCard
                          variant="interactive"
                          className="h-full hover:scale-105 transition-all duration-500 group"
                        >
                          <EnhancedCardContent className="p-6 text-center">
                            <div
                              className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-r ${gradientClass} flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                            >
            ...
            <section
              className="py-16 sm:py-20 md:py-24 bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-800/50 dark:via-gray-900/50 dark:to-gray-800/50"
              role="region"
            ...
            >
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                  <Badge
                    variant="secondary"
                    className="mb-6 px-4 py-2 text-sm font-medium bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 border border-green-200 dark:border-green-800"
                  >
                  ...
                  <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                    Join millions of satisfied customers who trust Loconomy for
                    their service needs.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                  {[
                    ...
                    <EnhancedCard
                      key={index}
                      variant="glass"
                      className="hover:scale-105 transition-all duration-500 h-full"
                    >
                      <EnhancedCardContent className="p-8">
                        <div className="flex items-start mb-6">
                          <div
                            className={`w-14 h-14 bg-gradient-to-r ${testimonial.gradient} rounded-2xl flex items-center justify-center mr-4 shadow-lg`}
                          >
            ...
            >
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                  <Badge
                    variant="secondary"
                    className="mb-6 px-4 py-2 text-sm font-medium bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 border border-orange-200 dark:border-orange-800"
                  >
                  ...
                  {[
                    {
                      ...
                      description:
                        'Tell us what you need. Our AI understands your requirements and finds the perfect matches in your area.',
                      icon: MousePointer,
                      gradient: 'from-blue-500 to-purple-500',
                    },
                    {
                      ...
                      description:
                        'Our intelligent algorithm instantly matches you with qualified, vetted professionals who are available and ready to help.',
                      icon: Brain,
                      gradient: 'from-purple-500 to-pink-500',
                    },
                    {
                      ...
                      title: 'Hire & Relax',
                      description:
                        'Compare profiles, get instant quotes, and hire the best fit. Track progress and pay securely through our platform.',
                      icon: CheckCircle,
                      gradient: 'from-green-500 to-teal-500',
                    },
                  ].map((step, index) => (
                    <div key={index} className="relative text-center z-10">
                      <div className="bg-white dark:bg-gray-800 rounded-full p-2 w-fit mx-auto mb-6 shadow-lg">
                        <div
                          className={`w-20 h-20 rounded-full bg-gradient-to-r ${step.gradient} flex items-center justify-center shadow-lg`}
                        >
                      ...
                      <div
                        className={`w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-r ${step.gradient} flex items-center justify-center shadow-lg`}
                      >
            ...
            <section className="py-16 sm:py-20 md:py-24 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 relative overflow-hidden">
              ...
              <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
                ...
                <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto opacity-90 leading-relaxed">
                  Join millions of satisfied customers and providers who have
                  transformed their service experience with Loconomy's
                  AI-powered platform.
                </p>
