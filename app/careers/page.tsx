...
const jobOpenings = [
  {
    ...
    salary: '$180k - $250k',
    description:
      'Lead development of our quantum-enhanced neural matching algorithms that power intelligent service discovery.',
    requirements: [
      'PhD in CS/AI or equivalent',
      '5+ years ML/AI experience',
      'PyTorch/TensorFlow expertise',
      'Neural architecture experience',
    ],
    benefits: [
      'Equity package',
  ...
  },
  {
    ...
    salary: '$150k - $200k',
    description:
      'Build beautiful, performant user interfaces for our AI-powered local services platform using cutting-edge technologies.',
    requirements: [
  ...
  },
  {
    ...
    salary: '$140k - $180k',
    description:
      'Drive product strategy for AI-powered features that create magical user experiences and increase platform engagement.',
    requirements: [
  ...
  },
  {
    ...
    salary: '$130k - $170k',
    description:
      'Design intuitive interfaces for complex AI systems, making artificial intelligence feel natural and magical for everyday users.',
    requirements: [
      '5+ years UX design',
      'AI/ML interface experience',
      'Figma mastery',
      'User research skills',
    ],
    benefits: [
  ...
  },
  {
    ...
    salary: '$120k - $160k',
    description:
      'Analyze user behavior patterns and optimize growth funnels using advanced statistical modeling and machine learning.',
    requirements: [
  ...
  },
  {
    ...
    salary: '$160k - $210k',
    description:
      'Secure our AI infrastructure and protect user data with next-generation security protocols and quantum-resistant encryption.',
    requirements: [
...
const companyValues = [
  {
    ...
    description:
      'We leverage cutting-edge AI to solve real-world problems and create magical user experiences.',
    icon: Brain,
    gradient: 'from-purple-500 to-pink-500',
  },
  {
    ...
    description:
      'Work from anywhere with a team that values flexibility, trust, and work-life balance.',
    icon: Globe,
    gradient: 'from-blue-500 to-cyan-500',
  },
  {
    ...
    description:
      'Every line of code and design decision directly improves lives and strengthens communities.',
    icon: Heart,
    gradient: 'from-green-500 to-teal-500',
  },
  {
    ...
    description:
      'Grow your skills with generous learning budgets, mentorship, and challenging projects.',
    icon: Lightbulb,
...
const benefits = [
  {
    ...
    description: 'Premium health, dental, vision + $2k wellness budget',
  },
  {
    icon: Rocket,
    title: 'Equity & Growth',
    description: 'Meaningful equity package with high growth potential',
  },
  {
    icon: Monitor,
    title: 'Remote-First',
    description: 'Work from anywhere + $3k home office setup budget',
  },
  {
    icon: Coffee,
    title: 'Unlimited PTO',
    description: 'Take time when you need it + quarterly company retreats',
  },
  {
    icon: Award,
    title: 'Learning Budget',
    description: '$5k annual budget for courses, conferences, books',
  },
  {
    icon: Users,
    title: 'Amazing Team',
    description: 'Work with brilliant, passionate people who care deeply',
  },
]
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto mb-12 leading-relaxed">
              Join a team of brilliant minds creating AI-powered solutions that
              connect people with perfect local services. Work on cutting-edge
              technology that impacts millions of lives worldwide.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                These positions have direct impact on our AI capabilities and
                user experience.
              </p>
            </div>
      ...
      <section className="py-16 px-4 bg-white/50 dark:bg-gray-800/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Join our growing team and help shape the future of AI-powered
              services.
            </p>
          </div>
              ...
              >
                <EnhancedCardContent className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div
                      className={`w-12 h-12 rounded-xl bg-gradient-to-r ${job.gradient} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                    >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Our values guide everything we do, from the code we write to the
              products we build.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {companyValues.map((value, index) => (
              <EnhancedCard
                key={index}
                variant="glass"
                className="hover:scale-105 transition-all duration-500 text-center"
              >
                <EnhancedCardContent className="p-8">
                  <div
                    className={`w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-r ${value.gradient} flex items-center justify-center shadow-lg`}
                  >
      ...
      <section className="py-16 px-4 bg-white/50 dark:bg-gray-800/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              We invest in our people with comprehensive benefits and a culture
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl mb-8 opacity-90 leading-relaxed">
            Join us in building AI that makes a real difference in people's
            lives. Your next adventure starts here.
          </p>
