  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden relative">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,rgba(79,124,255,0.15),transparent_60%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(0,212,255,0.12),transparent_60%)]" />
      </div>
      ...
      <section className="relative z-10 min-h-screen flex items-center justify-center px-6">
        <div className="max-w-7xl mx-auto text-center">
          {/* AI Status Badge */}
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full glass border border-neural-200/50 mb-12">
            ...
            <Bot className="w-5 h-5 text-neural-500" />
          </div>
          ...
          {/* Subtitle */}
          <p className="text-body-l text-muted-foreground mb-16 max-w-5xl mx-auto leading-relaxed">
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <div className="relative group">
              <div className="absolute -inset-2 bg-gradient-neural rounded-4xl blur-xl opacity-30 transition duration-1000" />
              <div className="relative glass-strong rounded-4xl p-3 border border-border shadow-glass-lg">
                <div className="flex items-center gap-6 px-8 py-6">
                  ...
                  <input
                    ...
                    className="flex-1 bg-transparent border-none outline-none text-foreground placeholder-muted-foreground text-lg font-medium"
                  />
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center mb-20">
            ...
            <Button
              size="lg"
              variant="outline"
              className="rounded-3xl px-16 py-6 font-bold text-xl border-2 transition-all duration-500"
              asChild
            >
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-80">
            {[
              ...
              <div
                key={index}
                className="flex items-center gap-3 text-base text-muted-foreground transition-all duration-300"
              >
      ...
      <section className="relative z-10 py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            <p className="text-body-l text-muted-foreground max-w-4xl mx-auto">
            ...
            {[
              ...
              >
                ...
                <CardContent className="p-0 relative z-10">
                  ...
                  <div className="text-5xl font-black mb-3 text-foreground">
                    {metric.value}
                  </div>
                  
                  <div className="text-heading-m font-semibold text-foreground mb-2">
                    {metric.label}
                  </div>
                  ...
                  <div className="text-sm text-trust-500 font-bold flex items-center gap-2">
      ...
      <section className="relative z-10 py-40 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative">
            <div className="absolute -inset-8 bg-gradient-neural rounded-4xl blur-3xl opacity-20" />
            <div className="relative glass-strong rounded-4xl p-16 border border-border shadow-glass-xl">
              <h2 className="text-display-l font-bold mb-8">
              ...
              <p className="text-body-l text-muted-foreground mb-16 max-w-3xl mx-auto">
