        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto mb-12 leading-relaxed">
              See how our AI-powered platform revolutionizes the way people find
              and book local services. This interactive demo showcases our
              quantum-enhanced matching algorithms in action.
            </p>
              ...
              {isLoading ? (
                <div className="flex flex-col items-center py-12">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Analyzing {demoSteps[currentStep]?.title.toLowerCase()}{' '}
                    requirements
                  </p>
                </div>
              ) : (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Our neural networks continuously learn and optimize to provide the
              best possible matches and experiences.
            </p>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              See how our AI has transformed the local services experience for
              thousands of users.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center text-white">
          ...
          <p className="text-xl mb-12 max-w-3xl mx-auto opacity-90 leading-relaxed">
            Join millions who have discovered the future of local services. Get
            matched with perfect providers in seconds.
          </p>
