...
interface ModernHeroServerProps {
  stats: {
    userCount: number
...
export function ModernHeroServer({ stats }: ModernHeroServerProps) {
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="lg:w-64">
                <div className="flex items-center bg-gray-50 dark:bg-gray-800/50 backdrop-blur rounded-xl p-4 border border-gray-200/50 dark:border-gray-700/50">
                  ...
                  <select className="flex-1 bg-transparent text-gray-900 dark:text-white outline-none font-medium">
              ...
              {aiInsights.map((insight, i) => (
                <div key={i} className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4 border border-gray-200/50 dark:border-gray-700/50">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <TrendingUp className={`w-4 h-4 ${insight.trend === 'up' ? 'text-green-500' : insight.trend === 'down' ? 'text-red-500' : 'text-gray-400'}`} />
                  </div>
