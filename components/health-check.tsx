  ...
  return (
    <div className="fixed bottom-4 left-4 z-50">
      ...
      >
        ...
        >
          <div
            className={`relative p-2 rounded-xl bg-gradient-to-r ${getHealthBg(healthScore)}`}
          >
            {overallHealth ? (
              <CheckCircle
                className={`w-5 h-5 ${getHealthColor(healthScore)}`}
              />
            ) : (
              <AlertCircle
                className={`w-5 h-5 ${getHealthColor(healthScore)}`}
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              ...
              <span
                className={`text-sm font-bold ${getHealthColor(healthScore)}`}
              >
                {healthScore}%
              </span>
            </div>
          ...
          <div className="px-4 pb-4 space-y-4 border-t border-white/20">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Brain
                    className={`w-4 h-4 ${metrics.hydration ? 'text-green-500' : 'text-red-500'}`}
                  />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Zap
                    className={`w-4 h-4 ${getHealthColor(metrics.performance)}`}
                  />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Shield
                    className={`w-4 h-4 ${metrics.errors === 0 ? 'text-green-500' : 'text-red-500'}`}
                  />
